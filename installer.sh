...
REPO="https://github.com/akkityagi12/Akki.git"
CURRENT_DIR="$(pwd)"
ENV_FILE_PATH=".env"
DIR="/root/akkityagi12"

while [ $# -gt 0 ]; do
    case "$1" in
    --dir=*)
        DIR="${1#*=}" || DIR="/root/akkityagi12"
        ;;
    --branch=*)
