...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to Akki, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf Akki")
    os.system("git clone https://github.com/akkityagi12/Akki")
    print("\n\nDone")
    os.chdir("Akki")
    clear_screen()
    print(a)
    ...
    all_done = "# Akki Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
