...
COPYRIGHT = f"©️ Aᴋᴋɪ {datetime.now().year}"
...
{Fore.BLACK}{Back.WHITE} _____________ 
 ...
 █▀█ █░█ █░█ █
{Style.RESET_ALL}
{Fore.GREEN}- AKKI Termux Installation -
  The Main Aim of this script is to deploy Akki with basic requirements and save your phone resources.
{Fore.RESET}
...
print(f"{Fore.YELLOW}* Do you want to get Akki Logs in Colors? [Y/N] ")
...
sleep(0.2)
print(f"Use 'bash startup' to try running Akki.{Fore.RESET}")
sleep(0.5)
print(
    "\nYou can head over to @tgr_hacker_group, if you get stuck somewhere, and need help."
)
sleep(0.5)
print("\nMade with ❤️ by @Tgr_hacker...")
