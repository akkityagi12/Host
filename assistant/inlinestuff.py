...
# <https://www.github.com/TeamAkki/Akki/blob/main/LICENSE/>.
...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/akkityagi12/Akki"),
        Button.url("• Support •", url="t.me/tgr_hacker_group"),
    ],
]
...
async def repo(e):
    ...
    await e.answer(res, switch_pm="Akki Repo.", switch_pm_param="start")
        ...
        return await ult.answer(
            [
                await ult.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by Akki",
                    url="https://t.me/Tgr_hacker",
                    text=text,
                )
            ],
            switch_pm="Tl Search 🔍",
...
InlinePlugin.update(
    {
        ...
        "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ": "go Aᴋᴋɪ",
        "WʜɪSᴘᴇʀ": "wspr @username Hello🎉",
        "YᴏᴜTᴜʙᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ": "yt Ed Sheeran Perfect",
        "Piston Eval": "run javascript console.log('Hello Akki')",
        "OʀᴀɴɢᴇFᴏx🦊": "ofox beryllium",
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter theAkki",
